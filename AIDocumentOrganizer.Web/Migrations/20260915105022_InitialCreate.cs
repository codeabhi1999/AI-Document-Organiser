        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderDaysBefore = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentNumberEncrypted = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DocumentNumberMasked = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    ProcessingErrorMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIProcessingLogs_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledForDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoredFilePath = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentTexts_DocumentVersions_DocumentVersionId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ColorCode", "DisplayOrder", "IconClass", "IsSystemDefault", "Name" },
                values: new object[,]
                {
                    { 1, "#4361ee", 1, "bi-person-badge", true, "Identity" },
                    { 2, "#3a0ca3", 2, "bi-building", true, "Government" },
                    { 3, "#f72585", 3, "bi-car-front", true, "Vehicle" },
                    { 4, "#7209b7", 4, "bi-shield-check", true, "Insurance" },
                    { 5, "#560bad", 5, "bi-mortarboard", true, "Education" },
                    { 6, "#480ca8", 6, "bi-bank", true, "Financial" },
                    { 7, "#3f37c9", 7, "bi-receipt", true, "Bills" },
                    { 8, "#4895ef", 8, "bi-house-door", true, "Property/Rental" },
                    { 9, "#4cc9f0", 9, "bi-heart-pulse", true, "Medical" },
                    { 10, "#6c757d", 10, "bi-folder", true, "Other" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AIProcessingLogs_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentReminders_ScheduledForDate",
                table: "DocumentReminders",
                column: "ScheduledForDate");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentReminders_Status",
                table: "DocumentReminders",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTexts_DocumentVersionId",
                table: "DocumentTexts",
